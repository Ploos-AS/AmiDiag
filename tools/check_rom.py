...
REQUIRED_MARKERS = (
    b"AMIDIAG proto=1 milestone=M2.7",
    b"BOOT phase=reset",
    b"BOOT.VECTORS",
    b"BOOT.SERIAL",
    b"MEM.FAULT.REPORT",
    b"fields=test,address,expected,actual",
    b"format=hex32",
    b"FAULT class=MEM test=",
    b" address=0x",
    b" expected=0x",
    b" actual=0x",
    b"DATA",
...
def main():
    ...
    print("PASS: M2.7 ROM fault-report/data/address/arena/march/discovery markers")
