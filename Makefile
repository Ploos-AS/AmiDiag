...
M3_6_ELF := $(BUILD)/amidiag-m3_6.elf
M3_6_ROM := $(BUILD)/amidiag-m3_6.rom
...
M3_6_LDFLAGS := -nostdlib -Wl,-T,linker.ld -Wl,-Map,$(BUILD)/amidiag-m3_6.map

.PHONY: all rom destructive-rom m3_1-rom m3_2-rom m3_3-rom m3_4-rom m3_5-rom m3_6-rom check check-destructive check-m3_1 check-m3_2 check-m3_3 check-m3_4 check-m3_5 check-m3_6 fsuae-smoke-512 fsuae-smoke-1024 fsuae-destructive fsuae-m3_1 fsuae-m3_2 fsuae-m3_3 fsuae-m3_4 fsuae-m3_5-512 fsuae-m3_5-1024 fsuae-m3_6-512 fsuae-m3_6-1024 qualify-m2_7 qualify-m2_8 qualify-m3_1 qualify-m3_2 qualify-m3_3 qualify-m3_4 qualify-m3_5 qualify-m3_6 clean

all: rom destructive-rom m3_1-rom m3_2-rom m3_3-rom m3_4-rom m3_5-rom m3_6-rom
...
$(BUILD)/m3_5_boot.o: src/cpu/m3_5_boot.S | $(BUILD)
	$(CC) $(ASFLAGS) -c $< -o $@
$(BUILD)/m3_6_boot.o: src/cpu/m3_6_boot.S | $(BUILD)
	$(CC) $(ASFLAGS) -c $< -o $@
...
$(M3_6_ELF): $(BUILD)/m3_6_boot.o linker.ld
	$(CC) $(ASFLAGS) $(M3_6_LDFLAGS) $(BUILD)/m3_6_boot.o -o $@
...
check-m3_6: m3_6-rom
	$(PYTHON) tools/check_m3_6_rom.py $(M3_6_ROM)
...
fsuae-m3_6-512: m3_6-rom
	CHIP_KIB=512 AMIDIAG_SERIAL_PORT=1243 sh tools/run_fsuae_m3_6.sh $(M3_6_ROM) $(BUILD)/m3_6-512-serial.txt
fsuae-m3_6-1024: m3_6-rom
	CHIP_KIB=1024 AMIDIAG_SERIAL_PORT=1244 sh tools/run_fsuae_m3_6.sh $(M3_6_ROM) $(BUILD)/m3_6-1024-serial.txt
...
qualify-m3_6: check-m3_6 fsuae-m3_6-512 fsuae-m3_6-1024
	@echo "PASS: M3.6 guarded multi-bank Chip RAM discovery on 512/1024 KiB profiles"
